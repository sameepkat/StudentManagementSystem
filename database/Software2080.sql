...
--
-- Host: localhost:3306
-- Generation Time: Jul 27, 2024 at 11:18 AM
...
CREATE TABLE `InternalResult1stSem` (
  ...
  `Basic_Eng_Drawing` int NOT NULL,
  `Calculus_I` int NOT NULL,
  `Digital_Logic` int NOT NULL,
  `Discrete_Struct` int NOT NULL,
  `PST` int NOT NULL,
  `Prog_C` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(1, 23180049, 'Ablk Paudel', '2023-1-18-0001', 47, 31, 40, 34, 46, 43),
...
(6, 23180053, 'Ashlsh Baral', '2023-1-18-0006', 44, 23, 40, 40, 40, 30),
...
(37, 23180082, 'San]ana Neupane', '2023-1-18-0035', 30, 32, 45, 47, 46, 44),
...
CREATE TABLE `studentInfo` (
  ...
  `Name` varchar(50) NOT NULL,
  `ExamRollNo` int NOT NULL,
  `PuRegNo` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
(7, 'Ashok Bohara', 23180054, '2023-1-18-0007', NULL, NULL, NULL, 'M'),
...
(22, 'Nishant Kumar Yadhav', 23180094, '2023-1-18-0194', NULL, NULL, NULL, 'M'),
...
INSERT INTO `studentLogin` (`soeId`, `Name`, `Password`) VALUES
